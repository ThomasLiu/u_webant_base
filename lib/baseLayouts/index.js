...
import { App } from 'u_webant'
import Authorized from '../baseUtils/Authorized';
import Footer from './Footer';
import Header from './Header';
import Context from './MenuContext';
import Exception403 from '../basePages/Exception/403';
import style from './index.less';
import { LS } from '../baseUtils'
import { getI18n } from '../baseServices/base';
      ...
      <Layout className={style.layout}>
        ...
        >
          <Header
            ...
            logo='http://image.hiredchina.com/logo.jpg'
            isMobile={isMobile}
            {...this.props}
          />
